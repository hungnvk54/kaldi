...
struct OnlineEndpointConfig {
  ...
  OnlineEndpointConfig():
      ...
      rule4(true, 0.3, std::numeric_limits<BaseFloat>::infinity(), 15.0), //rule4(true, 2.0, std::numeric_limits<BaseFloat>::infinity(), 0.0),
      rule5(false, 0.0, std::numeric_limits<BaseFloat>::infinity(), 35.0) { } //rule5(false, 0.0, std::numeric_limits<BaseFloat>::infinity(), 20.0) { }
